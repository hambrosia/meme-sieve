GEMINI_PROMPT = """You are an expert in memes and internet culture. Your job is to label an image as a meme: true / false.
...
MOONDREAM_PROMPT = "Return 'true' if this image is a meme, 'false' if not a meme"